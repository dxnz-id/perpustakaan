                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="no_rak" class="form-control" id="inputEmail3"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="no_laci" class="form-control" id="inputEmail3"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="no_boks" class="form-control" id="inputEmail3"
...
if ($_POST) {
    ...
    // Buat SQL
    $sql = "INSERT INTO buku (loker_buku, no_rak, no_laci, no_boks, judul_buku, nama_pengarang, tahun_terbit, penerbit, penerima, status, keterangan) VALUES ('$loker_buku', '$rak', '$laci', '$boks', '$judulbuku', '$pengarang', '$tahun_terbit', '$penerbit', '$penerima', '$status', '$ket')";
